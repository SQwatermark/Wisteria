...
public class FluidRenderer {
    ...
    public boolean render(BlockAndTintGetter world, FluidState fluidState, BlockPos pos, BlockPos offset, ChunkModelBuilder buffers) {
        ...
        if (fluidHeight >= 1.0f) {
            ...
            h1 = this.fluidCornerHeight(world, fluid, fluidHeight, north1, west1, pos.relative(Direction.NORTH).relative(Direction.WEST));
            ...
            h4 = this.fluidCornerHeight(world, fluid, fluidHeight, north1, east1, pos.relative(Direction.NORTH).relative(Direction.EAST));
        }
